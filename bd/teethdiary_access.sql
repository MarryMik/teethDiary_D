...
CREATE TABLE `access` (
  ...
  KEY `access_diary_idx` (`diary_id`),
  CONSTRAINT `access_diary` FOREIGN KEY (`diary_id`) REFERENCES `diary` (`iddiary`),
  CONSTRAINT `access_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`iduser`)
