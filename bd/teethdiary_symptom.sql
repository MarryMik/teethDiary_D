...
CREATE TABLE `symptom` (
  `idsymptom` int NOT NULL AUTO_INCREMENT,
  `symptom_name` varchar(65) DEFAULT NULL,
  `level_pain` float DEFAULT NULL,
  `symptom_date` date DEFAULT NULL,
  `symptom_datestart` datetime DEFAULT NULL,
  `diary_id` int DEFAULT NULL,
  PRIMARY KEY (`idsymptom`),
  KEY `diary_symptomp_idx` (`diary_id`),
  CONSTRAINT `diary_symptom` FOREIGN KEY (`diary_id`) REFERENCES `diary` (`iddiary`)
