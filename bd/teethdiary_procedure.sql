...
CREATE TABLE `procedure` (
  ...
  KEY `record_procedure_idx` (`record_id`),
  KEY `procedures_list_idx` (`procedures_id`),
  CONSTRAINT `procedures_list` FOREIGN KEY (`procedures_id`) REFERENCES `procedures` (`idprocedures`),
  CONSTRAINT `record_procedure` FOREIGN KEY (`record_id`) REFERENCES `teeth_record` (`idrecord`)
