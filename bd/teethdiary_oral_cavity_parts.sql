...
--
-- Table structure for table `oral_cavity_parts`
--

DROP TABLE IF EXISTS `oral_cavity_parts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `oral_cavity_parts` (
  `id_or_cav_part` int NOT NULL AUTO_INCREMENT,
  `partname` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id_or_cav_part`)
