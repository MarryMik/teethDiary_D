...
CREATE TABLE `treatment` (
  ...
  `start_date_trtment` date DEFAULT NULL,
  `end_date_trtment` date DEFAULT NULL,
  `diary_id` int DEFAULT NULL,
  PRIMARY KEY (`idtreatment`),
  KEY `diary_trtmnt_idx` (`diary_id`),
  CONSTRAINT `diary_trtmnt` FOREIGN KEY (`diary_id`) REFERENCES `diary` (`iddiary`)
